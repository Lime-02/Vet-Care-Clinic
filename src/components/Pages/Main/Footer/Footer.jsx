...
const Footer = () => {
  ...
  const sendEmail = async (e) => {
    console.log('Sending email: ' + JSON.stringify(e));
    // const id = e.user_email
    // const something = await getAllDocumentsFromCollection("users")
    ...
    if (!userSent) {
        ...
        setMessage("Please register or sign in to send an email.");
        return;
    }
    ...
    try {
      ...
      if (userSent.sent === false) {
        console.log(`Email JS values: ${import.meta.env.VITE_SERVICE_ID}`);
