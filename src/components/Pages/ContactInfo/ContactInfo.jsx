          ...
          <div className="-m-3 flex flex-wrap">
            <div className="w-full p-3 md:w-1/3">
              <div className="border-blueGray-100 shadow-11xl h-full rounded-xl border bg-bgGreen bg-opacity-90 p-11 text-center shadow-md">
                ...
                <p className="font-medium leading-relaxed">We are 8-5</p>
              </div>
            </div>
            <div className="w-full p-3 md:w-1/3">
              <div className="border-blueGray-100 shadow-11xl h-full rounded-xl border bg-bgGreen bg-opacity-90 p-11 text-center shadow-md">
            ...
            <div className="w-full p-3 md:w-1/3">
              <div className="border-blueGray-100 shadow-11xl h-full rounded-xl border bg-bgGreen bg-opacity-90 p-11 text-center shadow-md">
                ...
                <p className="mx-auto max-w-xs font-medium leading-relaxed">
                  4,Railway Parallel Road, Gnanabharathi Stage 2, Kengeri Satellite Town, Bengaluru, Karnataka 560060, India<br/>
                  <a 
                    href="https://maps.app.goo.gl/BxT3SjmBL6cRQCU66" 
                    target="_blank" 
