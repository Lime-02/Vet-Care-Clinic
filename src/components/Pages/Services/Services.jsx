...
const Services = () => {
  return (
    <div className="min-h-screen bg-[#adc6af]">
      <NavBar bg={"#adc6af"} />
      <h2 className="font-heading tracking-px-n mb-10 text-center text-5xl font-bold leading-none text-bgGreen md:text-7xl xl:text-8xl">
      ...
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-4 px-4 pb-10 sm:grid-cols-2 sm:grid-rows-2 lg:grid-cols-4">
        {services.map((service) => (
            ...
            <div key={service.id} className="content flex flex-col items-center justify-around rounded-sm border border-bgGreen pl-7 pt-7 pr-7 pb-7 text-sm duration-200 group-hover:bg-bgGreen sm:h-full">
              <img
